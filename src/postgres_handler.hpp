...
protected:
    ...
    PostgresHandler(Config& config, Columns& node_columns, Columns& untagged_nodes_columns, Columns& way_linear_columns, Columns& way_polygon_columns,
     ...
     */
    PostgresHandler(Columns& node_columns, Columns& untagged_nodes_columns, Columns& way_linear_columns, Columns& way_polygon_columns,
            Columns& relation_polygon_columns, Config& config)  :
            wkb_factory(osmium::geom::wkb_type::wkb, osmium::geom::out_type::hex),
            ...
            m_ways_polygon_table(way_polygon_columns, config),
            m_relations_polygon_table(relation_polygon_columns, config) {}
